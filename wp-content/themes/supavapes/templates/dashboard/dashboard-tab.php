	...
	<div class="chart-container">
		...
		<div class="year-dropdown">
			...
			<div class="tabs">
				...
				<div class="tab" data-tab="week"><?php esc_html_e('Weekly','supavapes'); ?></div>
			</div>
		</div>
	...
	<div class="dashboard-six-box">
		<div class="dashboard-box">
			...
			<div class="dashboard-box-data">
				...
				<div class="dashboard-box-data-detail">
					...
					if (!empty($product_names)) { 
						foreach ($product_names as $product_name) {
							if($count === 1){
					?>
					<p class="dashboard-box-data-value"><?php echo esc_html($product_name,'supavapes'); ?></p>
					<?php 
						}
					$count++;
						}
				...
				<div class="dashboard-box-data-detail">
					<label class="dashboard-box-data-lable"><?php esc_html_e('Order Total test dev','supavapes'); ?></label>
					<p class="dashboard-box-data-value">$<?php echo esc_html($order_total); ?></p>
				</div>
			</div>
			<?php }else{
				esc_html_e("No order has been made yet.",'supavapes');	
			}?>
		</div>
		<div class="dashboard-box">
			<h3 class="dashboard-box-title"><?php esc_html_e('Money Savior','supavapes'); ?></h3>	
			<div class="money-save-box">	
				<h4 class="money-save-value"><?php echo do_shortcode('[total_savings]');?></h4>	
				<p class="money-save-text"><?php esc_html_e('Saved by not consuming cigarettes','supavapes'); ?></p>
			</div>
		</div>
		<div class="dashboard-box">
			<h3 class="dashboard-box-title"><?php esc_html_e('Notifications','supavapes'); ?></h3>
			<?php 
				$user_id = get_current_user_id();
			...
			<div class="dashboard-box-notification">
				<span class="notification-selction">
					...
					<label class="notification-selction-email <?php echo esc_attr($email_class); ?>">
						...
						</svg><?php echo esc_html__('By Email','supavapes'); ?>
					</label>
				</span>
				<!-- <span class="notification-selction"> -->
					<?php 
					...
					<!-- <label class="notification-selction-whatsapp <?php //echo esc_attr($whatsapp_class); ?>">
						...
						</svg><?php //echo esc_html__('By Whatsapp','supavapes');?>
					</label> -->
				<!-- </span> -->
				<span class="notification-selction">
					<?php 
					...
					<label class="notification-selction-sms <?php echo esc_attr($sms_class); ?>">
						...
						</svg><?php esc_html_e('By Sms','supavapes');?>
					</label>
				</span>
			</div>
		</div>
		<div class="dashboard-box">
			<h3 class="dashboard-box-title"><?php esc_html_e('Last login','supavapes'); ?></h3>	
			<?php 
