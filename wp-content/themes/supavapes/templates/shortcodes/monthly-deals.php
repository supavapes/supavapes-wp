				...
				<div class="sv-our-product-box">
					...
					if ( $product_data && method_exists( $product_data, 'get_type' ) ) {
						...
						if( $product_type === 'variable' ){?>
							<a href="<?php echo esc_url(get_permalink()); ?>" class="sv-shop-btn"><?php echo esc_html__('Select Options','hello-elementor-child'); ?></a>
						<?php }else{?>
							<a href="<?php echo esc_url(get_permalink()); ?>" class="sv-shop-btn"><?php echo esc_html__('Shop Now','hello-elementor-child'); ?></a>
						<?php }?>
					<?php }?>
