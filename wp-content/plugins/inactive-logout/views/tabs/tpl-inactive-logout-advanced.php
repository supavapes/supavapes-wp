 ...
 */
$ina_multiuser_timeout_enabled = \Codemanas\InactiveLogout\Helpers::get_option( '__ina_enable_timeout_multiusers' );
if ( $ina_multiuser_timeout_enabled ) {
	$ina_multiuser_settings = \Codemanas\InactiveLogout\Helpers::get_option( '__ina_multiusers_settings' );
}
?>
