<?php
/**
 * Class WC_Send_Support_Request file.
 *
...
if ( ! class_exists( 'WC_Send_Support_Request', false ) ) :
	 ...
	 *
	 * @class       WC_Send_Support_Request
	 * @version     3.5.0
	 * @package     WooCommerce\Classes\Emails
	 * @extends     WC_Email
	 */
	class WC_Send_Support_Request extends WC_Email {

		/**
		 * @var string $email_template_name
		 */
		public $email_template_name = 'support_request';
...
return new WC_Send_Support_Request();
