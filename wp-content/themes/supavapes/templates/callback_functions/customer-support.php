<?php 
/**
 * This file is contains the html for the customer support popup
 */
?>
<span class="deal-popup-close">
...
<div class="deal-popup-content-box">
	...
	<div class="select-order-item-box">
		...
		<div class="additional-info-box">
			<textarea id="additional-info" placeholder="<?php esc_html_e( 'Additional information', 'supavapes' ); ?>"></textarea>
		</div>
		<button type="submit" class="button">
			<span><?php esc_html_e( 'Sign Up', 'supavapes' ); ?></span>
