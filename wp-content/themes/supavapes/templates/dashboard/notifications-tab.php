<?php
/**
 * This file is used for shiwing notification content for customer dashbaord.
 */
...
<form method="post" class="woocommerce-EditAccountForm">
	<h2><?php esc_html_e( 'Select your preferences to receive notification alerts.', 'supavapes' ); ?></h2>
		...
		<label for="notification-preferences">
			<span class="notification-selction">
				...
				<label for="email">
					...
					</svg><?php esc_html_e( 'By Email', 'supavapes' ); ?>
				</label>
			</span>
			<!-- <span class="notification-selction">
				...
				<label for="whatsapp">
					...
					</svg><?php //echo esc_html('By Whatsapp','supavapes');?>
				</label>
			</span> -->
			<span class="notification-selction">
				...
				<label for="sms">
					...
					<?php esc_html_e( 'By Sms', 'supavapes' );?>
				</label>
			</span>
		</label>
	</p>
	<?php 
		if ( isset( $_SESSION['preferences_saved'] ) && $_SESSION['preferences_saved'] ) {
			echo '<div class="notice notice-success"><p>' . esc_html__( 'Preferences saved successfully.', 'supavapes' ) . '</p></div>';
			unset( $_SESSION['preferences_saved'] );
		}
	?>
	<p>
		<button type="submit" class="woocommerce-Button button" name="save_preferences" value="Save">
			<?php esc_html_e( 'Save Preferences', 'supavapes' ); ?>
		</button>
		<p>
			<?php esc_html_e( 'Disclaimer: Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem ipsum Lorem', 'supavapes' ); ?>
		</p>
