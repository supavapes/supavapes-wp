jQuery(function ($) {
    ...
    function jdgmToggleWidgetIcons(toggleElement) {
        ...
        if (jQuery(toggleElement).is(":checked")) {
            var newText = isClearCacheToggle ? 'Clear cache by default' : 'Installed';
    ...
    document.querySelectorAll('.home-page__header-rate-us-stars-container i').forEach((star, index) => {
        star.addEventListener('mouseover', function() {
            let hoverIndex = index;
            document.querySelectorAll('.home-page__header-rate-us-stars-container i').forEach((element, elementIndex) => {
                if (elementIndex <= hoverIndex) {
        ...
        star.addEventListener('mouseout', function() {
            document.querySelectorAll('.home-page__header-rate-us-stars-container i').forEach(star => {
