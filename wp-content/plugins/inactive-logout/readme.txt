...
* Changed: Styling
* Added: User based tab.
* Minor bug fixes

= 3.4.6 - November 6th, 2024 =
...
= 3.4.2 - August 19th, 2024 =
* Compatibility with openID generic SSO plugin logout. Needs pro version on inactive logout though.

= 3.4.1 - August 17th, 2024 =
* Fixed: CSP blob issue - Removed workerTimers from script.

= 3.4.0 - August 11th, 2024 =
* DB Options optimization
* Refactor code

= 3.3.4 - June 27th, 2024 =
* Added: Bottom counter bar text customizable.
* Added: Throttle detection for inactive tabs.
* Minor changes.
...
= 3.3.1 - May 16th, 2024 =
* Added: Date format for counter bar based on WordPress date time setting.
* Fixed: Minor JS warning shown in inactive settings page.
* Translations updated.

= 3.3.0 - April 19th, 2024 =
* New Feature: Popup and redirect for non authenticated users.
* Updated translations.
* Optimized javascript

= 3.2.6 - March 14th, 2024 =
* Fixed: wp_footer and wp_header priority issue for logout popups.
