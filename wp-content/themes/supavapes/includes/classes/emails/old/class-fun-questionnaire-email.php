...
class Fun_Questionnaire_Email extends WC_Email {
	...
	public function __construct() {
		...
		$this->description = __( 'An email sent to the customer pass the quize.', 'supavapes' );

		// For admin area to let the user know we are sending this email to the customer.
		$this->customer_email = true;
		$this->heading        = __( 'Won the quize', 'supavapes' );

		// translators: placeholder is {blogname}, a variable that will be substituted when email is sent out.
		$this->subject = sprintf( _x( '[%s] Congratulations', 'default email subject for rental ggreement being sent to the customer', 'supavapes' ), '{blogname}' );
