	...
	class IMPORT_SHOPIFY_TO_WOOCOMMERCE_ADMIN_Cron_Update_Orders {
                ...
                <form class="vi-ui form" method="post">
                    ...
                    <div class="vi-ui segment">
                        ...
                        <table class="form-table">
                            ...
                            <tr>
                                <th>
                                    <label for="<?php echo esc_attr( self::set( 'cron_update_orders_interval' ) ) ?>"><?php esc_html_e( 'Run update every', 'import-shopify-to-woocommerce' ) ?></label>
                                </th>
                                <td>
                            ...
                            <tr>
                                <th>
                                    <label for="<?php echo esc_attr( self::set( 'cron_update_orders_hour' ) ) ?>"><?php esc_html_e( 'Run update at', 'import-shopify-to-woocommerce' ) ?></label>
                                </th>
                                <td>
                            ...
                            <tr>
                                <th>
                                    <label for="<?php echo esc_attr( self::set( 'cron_update_orders_status' ) ) ?>"><?php esc_html_e( 'Only update orders with status:', 'import-shopify-to-woocommerce' ) ?></label>
                                </th>
                                <td>
                            ...
                            <tr>
                                <th>
                                    <label for="<?php echo esc_attr( self::set( 'cron_update_orders_range' ) ) ?>"><?php esc_html_e( 'Only update orders created in the last x day(s):', 'import-shopify-to-woocommerce' ) ?></label>
                                </th>
                                <td>
                                    <div class="vi-ui right labeled input">
		...
		public function admin_enqueue_script( $page ) {
			if ( $page === 'shopify-to-woo_page_import-shopify-to-woocommerce-cron-update-orders' ) {
				...
				wp_enqueue_style( 'import-shopify-to-woocommerce-cron-update-orders', VI_IMPORT_SHOPIFY_TO_WOOCOMMERCE_CSS . 'cron-update-orders.css', '', VI_IMPORT_SHOPIFY_TO_WOOCOMMERCE_VERSION );
				wp_enqueue_script( 'import-shopify-to-woocommerce-cron-update-orders', VI_IMPORT_SHOPIFY_TO_WOOCOMMERCE_JS . 'cron-update-orders.js', array( 'jquery' ), VI_IMPORT_SHOPIFY_TO_WOOCOMMERCE_VERSION, true );
			}
		}
	}
}
