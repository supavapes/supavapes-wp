					...
					<tr class="woocommerce-cart-form__cart-item <?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
						...
						<td class="product-price" data-title="<?php esc_attr_e( 'Price', 'woocommerce' ); ?>">
							...
							<?php if ( isset( $vaping_liquid ) && !empty( $vaping_liquid ) && $vaping_liquid >= 10 ) { 
								echo supavapes_price_breakdown_custom_html( WC()->cart->get_product_price( $_product ), $federal_tax, $ontario_tax, $final_price, $state );
							}?>
						</td>
...
<div class="cart-collaterals">
	<?php
		...
		<div class="cart-total-right">
			<p><?php echo esc_html__('Taxes and shipping calculated at checkout','supavapes'); ?></p>
			<div class="cart-shop-links">
				<p class="continue-shopping"><?php echo esc_html__('Continue Shopping','supavapes'); ?>
				...
				<span><?php echo esc_html__('Shop Now','supavapes'); ?></span>
				</a>
			</div>
		</div>
		<?php
