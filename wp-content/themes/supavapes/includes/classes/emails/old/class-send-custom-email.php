...
class Send_Custom_Email extends WC_Email {
	...
	public function __construct() {
		...
		$this->title       = __( 'Supavapes: Send Custom Email', 'supavapes' );
		...
		$this->heading        = __( 'Custom Email', 'supavapes' );

		// translators: placeholder is {blogname}, a variable that will be substituted when email is sent out.
		$this->subject = sprintf( _x( '[%s] Custom Email', 'default email subject for rental ggreement being sent to the customer', 'supavapes' ), '{blogname}' );
