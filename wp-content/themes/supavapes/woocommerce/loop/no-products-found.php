...
<div class="woocommerce-no-products-found">
	...
	<div class="no-products-found-box">
		<p class="no-products-found-text"><?php esc_html_e('No products found matching your search criteria. Please try again.','supavapes'); ?></p>
		<a href="/shop" class="button reset-filter"><?php esc_html_e('Reset Filter','supavapes');?>
