...
<div class="surface-pick-up-modal__header">
    <h2 class="surface-pick-up-modal__title"><?php echo esc_html(get_the_title($product_id),'supavapes'); ?></h2>
</div>
<?php if ( isset( $term_data ) && !empty( $term_data ) ) {?>
            ...
            <li class="surface-pick-up-item surface-pick-up-item--available" data-surface-pick-up-item="">
                <div class="surface-pick-up-item__header">
                    ...
                    <p class="surface-pick-up-item__pick-up-distance">
                        ...
                        <span data-distance-unit="metric"><?php esc_html_e('km','supavapes'); ?></span>
                    </p>
                </div>
                ...
                <div class="surface-pick-up-item__availability"> 
                    ...
                    <?php esc_html_e('Pickup available, usually ready in 24 hours','supavapes'); ?>            
                </div>
                <?php }else{ ?>
                <div class="surface-pick-up-item__availability unavailable"> 
                    ...
                    <?php esc_html_e('Pickup currently unavailable','supavapes'); ?>           
                </div> 
                <?php }?>
