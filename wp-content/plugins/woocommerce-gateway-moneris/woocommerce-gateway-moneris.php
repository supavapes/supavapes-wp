 ...
 * Plugin URI: https://woocommerce.com/products/moneris-gateway
 * Documentation URI: https://docs.woocommerce.com/document/moneris/
...
class WC_Moneris_Loader {
	...
	/** @var \WC_Moneris_Loader single instance of this class */
	...
	protected function __construct() {
		...
		add_filter( 'extra_plugin_headers', [ $this, 'add_documentation_header' ] );
	...
	/**
	 * Displays any admin notices added with \WC_Moneris_Loader::add_admin_notice().
	 *
	 * @internal
	 *
	 * @since 2.11.0
	...
	/**
	 * Gets the main \WC_Moneris_Loader instance.
	 *
	 * Ensures only one instance can be loaded.
	 *
	 * @since 2.11.0
	 *
	 * @return \WC_Moneris_Loader
	 */
