...
class Shipment_Ready_Email extends WC_Email {
	...
	public function __construct() {
		...
		$this->heading        = __( 'Ready For Shipment', 'supavapes' );

		// translators: placeholder is {blogname}, a variable that will be substituted when email is sent out.
		$this->subject = sprintf( _x( '[%s] Ready For Shipment', 'default email subject for rental ggreement being sent to the customer', 'supavapes' ), '{blogname}' );
