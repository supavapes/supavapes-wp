...
/**
 * Class Twilio_Order_Cancelled_SMS
 */
class Twilio_Order_Cancelled_SMS extends Twilio_SMS {
	 ...
	 * @var string
	 */
	private $template_name = 'order_cancelled';

	/**
	 * Twilio_Order_Cancelled_SMS constructor.
	 */
	public function __construct() {
		$this->init();

		// Triggers for this email.
		add_action( 'woocommerce_order_status_processing_to_cancelled', array( $this, 'trigger' ), 10, 2 );
		add_action( 'woocommerce_order_status_on-hold_to_cancelled', array( $this, 'trigger' ), 10, 2 );
	}
...
new Twilio_Order_Cancelled_SMS();
