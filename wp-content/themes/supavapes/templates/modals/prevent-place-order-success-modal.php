<?php
// This file is used for show success message on prevent place order request submit.
            ...
            <div class="sv-email-modal__body">
                <div class="sv-email-modal__heading-info">
                    <?php if ( !empty( $checkout_prevent_success_popup_thank_you_text) ) { ?>
                        <h2 class="sv-email-modal__title"><?php echo esc_html( $checkout_prevent_success_popup_thank_you_text ); ?></h2>
                    <?php }?>
                    <?php if ( !empty( $checkout_prevent_success_popup_thank_you_message ) ) { ?>
                        <p class="sv-email-modal__description"><?php echo esc_html( $checkout_prevent_success_popup_thank_you_message ); ?></p>
                    <?php }?>
                </div>
            </div>
        </div>
