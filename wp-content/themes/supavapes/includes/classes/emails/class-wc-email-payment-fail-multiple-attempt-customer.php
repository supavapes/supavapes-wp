<?php
/**
 * Class WC_Email_Payment_Fail_Multiple_Attempt_Order file.
 *
...
if ( ! class_exists( 'WC_Email_Payment_Fail_Multiple_Attempt_Order', false ) ) :

	/**
	 * Payment fail multiple attempt order Email.
	 *
	 * An email sent to the customer when a order is payment fail multiple attempt for.
	 *
	 * @class       WC_Email_Payment_Fail_Multiple_Attempt_Order
	 * @version     3.5.0
	 * @package     WooCommerce\Classes\Emails
	 * @extends     WC_Email
	 */
	class WC_Email_Payment_Fail_Multiple_Attempt_Order extends WC_Email {

		/**
		 * @var string $email_template_name
		 */
		public $email_template_name = 'multiple_payment_attempt_failure_customer_email';
...
return new WC_Email_Payment_Fail_Multiple_Attempt_Order();
