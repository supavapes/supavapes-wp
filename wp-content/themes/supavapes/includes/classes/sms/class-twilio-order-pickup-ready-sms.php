...
/**
 * Class Twilio_Order_Pickup_Ready_SMS
 */
class Twilio_Order_Pickup_Ready_SMS extends Twilio_SMS {
	 ...
	 * @var string
	 */
	private $template_name = 'pickup_ready';

	/**
	 * Twilio_Order_Pickup_Ready_SMS constructor.
	 */
	public function __construct() {
		$this->init();

		// Triggers for this email.
		add_action( 'woocommerce_order_status_processing_to_pickup-ready', array( $this, 'trigger' ), 10, 2 );
	}
...
new Twilio_Order_Pickup_Ready_SMS();
