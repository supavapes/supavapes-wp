<?php
/**
 * Class WC_Send_Decline_Request file.
 *
...
if ( ! class_exists( 'WC_Send_Decline_Request', false ) ) :

	/**
	 * Decline request Email.
	 *
	 * An email sent to the customer when a decline request
	 *
	 * @class       WC_Send_Decline_Request
	 * @version     3.5.0
	 * @package     WooCommerce\Classes\Emails
	 * @extends     WC_Email
	 */
	class WC_Send_Decline_Request extends WC_Email {

		/**
		 * @var string $email_template_name
		 */
		public $email_template_name = 'decline_request';
...
return new WC_Send_Decline_Request();
