...
You can use our dedicated [support portal](https://support.shelfplanner.com/en "support portal")- or simply drop us a line at [support@shelfplanner.com](mailto:support@shelfplanner.com "support@shelfplanner.com").
...
= 2.1.1 =
* Minor fix for deactivation

= 2.1.0 =
* Minor fix for order sync
* Improved onboarding process

= 2.0.0 =
* Introduces the new Shelf Planner User Interface
