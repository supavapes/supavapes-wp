...
if ( ! class_exists( 'WC_Email_Subscribe_User', false ) ) :
	...
	class WC_Email_Subscribe_User extends WC_Email {
		...
		public function __construct() {
			...
			$this->title          = __( 'Subscriber User Email', 'supavapes' );
			$this->description    = __( 'An email sent to the customer when subscribe to Newsletter.', 'supavapes' );
		...
		public function get_default_subject() {
			return __( 'Subscribed to Newsletter', 'supavapes' );
		}
		...
		public function get_default_heading() {
			return sprintf( _x( '[%s] Subscribed Successfully ', 'default email subject for rental agreement being sent to the customer', 'supavapes' ), '{blogname}' );
		}
