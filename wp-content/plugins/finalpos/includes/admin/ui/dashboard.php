                        ...
                        <tr>
                            ...
                            <td class="content-actions">
                                <table class="action-icons">
                                    <tr>
                                        <td><a href="<?php echo esc_url($content['view_link']); ?>"><span
                                                    class="material-symbols-outlined uxlabs-boxed-icon">visibility</span></a>
                                        </td>
                                        <td><a href="<?php echo esc_url($content['edit_link']); ?>"><span
                                                    class="material-symbols-outlined uxlabs-boxed-icon">more_horiz</span></a>
                                        </td>
                                    </tr>
                                </table>
                            </td>
                ...
                <div class="kanban-column" data-status="<?php echo esc_attr($status_key); ?>">
                    <h4>
                        <span class="status-circle"
                            style="background-color: <?php echo esc_attr($status_info['color']); ?>"></span>
                    ...
                    <div class="kanban-items" id="<?php echo esc_attr($status_key); ?>-items">
                        ...
                        foreach ($orders as $order): ?>
                            <div class="kanban-item" draggable="true" data-order-id="<?php echo esc_attr($order['id']); ?>"
                                data-status="<?php echo esc_attr($status_key); ?>">
                                <div class="order-header">
                                    <span class="order-customer"><?php echo esc_html($order['customer']); ?></span>
                                    <span class="order-number"
                                        style="color: <?php echo esc_attr($status_info['color']); ?>; background-color: <?php echo esc_attr($status_info['color']); ?>20;">#<?php echo esc_html($order['number']); ?></span>
                                </div>
                                <div class="order-details">
                                    <span class="order-total"><?php echo wp_kses_post(wc_price($order['total'])); ?></span>
                                    <span
                                        class="order-date"><?php echo esc_html(gmdate('Y-m-d H:i', strtotime($order['date']))); ?></span>
                                </div>
                            </div>
                        <?php endforeach; ?>
                    </div>
...
function final_admin_dashboard_content()
{
    ...
    if ($wizard_status !== 'completed_sync' && !get_option('final_pos_consumer_key')) {
        wp_redirect(admin_url('admin.php?page=final-pos-setup'));
        exit;
    }
