 ...
 */
 ...
 $location_address_field_label              =   get_field( 'location_address_field_label', 'option' );
 $location_update_location_label            =   get_field( 'location_update_location_label', 'option' );
 $location_detect_me_label                  =   get_field( 'location_detect_me_label', 'option' );
 $location_enter_manually_label             =   get_field( 'location_enter_manually_label', 'option' );
 $enter_manually_form_heading               =   get_field( 'enter_manually_form_heading', 'option' );
 $enter_manually_form_submit_button_label   =   get_field( 'enter_manually_form_submit_button_label', 'option' );
?> 
            ...
            <div class="location-popup-content-main">
               ...
               <div class="custom-location-wrap">
                    <div class="custom-location-input-box">
                     <?php if ( !empty( $location_address_field_label ) ) { ?>
                        <label><?php echo esc_html(  $location_address_field_label  ); ?></label>
                     <?php } ?>
                  ...
                  <div class="custom-location-buttons">
                    <?php if ( !empty( $location_detect_me_label ) ) { ?>
                     <a href="javascript:void(0);" id="detect-me-button"><?php echo esc_html( $location_detect_me_label ); ?></a>
                    <?php } ?>
                    <?php if ( !empty( $location_enter_manually_label ) ) { ?>
                     <button class="enter-menual-btn"><?php echo esc_html( $location_enter_manually_label ); ?></button>
                    <?php } ?>
                  </div>
               </div>
            ...
            <div class="location-popup-form">
               ...
               <div class="location-popup-form-content">
                  ...
                  <div class="location-popup-form-content-box">
                    ...
                    <?php if ( !empty( $enter_manually_form_heading ) ) { ?>
                        <h2><?php echo esc_html( $enter_manually_form_heading ); ?></h2>
                    <?php } ?>
