...
class Self_Pickup_Email extends WC_Email {
	...
	public function __construct() {
		...
		$this->title       = __( 'Self Pickup', 'supavapes' );
		...
		$this->heading        = __( 'Self Pickup', 'supavapes' );

		// translators: placeholder is {blogname}, a variable that will be substituted when email is sent out.
		$this->subject = sprintf( _x( '[%s] Self Pickup', 'default email subject for rental ggreement being sent to the customer', 'supavapes' ), '{blogname}' );
