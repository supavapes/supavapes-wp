<?php
/**
 * This file is used to get monthly deals(category) slider data.
 */
defined( 'ABSPATH' ) || exit; // Exit if accessed directly.
	...
	$term_slug= get_term_by('slug','monthly-deals', 'product_cat');
			...
			while ($products->have_posts()) {
				...
				<div class="sv-our-product-box">
					...
					<div class="sv-our-product-detail">
						<h3 class="sv-our-product-title"><?php echo esc_html(get_the_title(),'supavapes'); ?></h3>
						<p class="sv-our-product-price"><?php echo wp_kses_post($price); ?></p>
					</div>
					<?php 
