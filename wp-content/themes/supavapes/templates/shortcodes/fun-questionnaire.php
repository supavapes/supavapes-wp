...
<div class="supa-quiz">
	<div class="supa-quiz-title">
		<div class="supa-quiz-title-text">
			<?php if ( ! empty( $fq_banner_heading ) ) { ?>
				<h2><?php echo esc_html( $fq_banner_heading ); ?></h2>
			<?php } ?>
			<?php if ( ! empty( $fq_banner_sub_heading ) ) { ?>
				<p><?php echo esc_html( $fq_banner_sub_heading ); ?></p>
			<?php } ?>
		</div>
		...
		<?php if ( ! empty( $fq_banner_button_text ) ) { ?>
			<a href="javascript:void(0);" class="supa-quiz-submit view-all-btn proceed">
				...
				<span><?php echo esc_html( $fq_banner_button_text ); ?></span>
			</a>
		<?php } ?>
	</div>
	<div class="supa-quiz-questions-section">
		...
		if ( have_rows( 'fq_questions_and_answers', 'option' ) ) :
			while ( have_rows( 'fq_questions_and_answers', 'option' ) ) :
				the_row();
				...
				<div class="supa-quiz-question" id="step_<?php echo esc_attr( $step_counter ); ?>">
					...
					if ( have_rows( 'steps', 'option' ) ) :
						while ( have_rows( 'steps', 'option' ) ) :
							...
							<div class="supa-quiz-question-inner" id="question_<?php echo esc_attr( $question_counter ); ?>">
								<h3><span><?php echo esc_html( $question_counter ); ?></span><?php echo esc_html( $question ); ?></h3>
								<ul class="choices">
									<?php
					...
					<div class="next-prev-btns">
						...
						<button class="supa-quiz-submit-answers" style="display: none;"><?php esc_html_e( 'Submit Answers', 'supavapes' ); ?></button>
					</div>
				</div>
				<?php
				++$step_counter;
		...
		<div class="congrats">
			<div class="supa-quiz-result-detail">
				...
				<?php if ( ! empty( $fq_congratulations_sub_heading ) ) { ?>
					<h3><?php echo esc_html( $fq_congratulations_sub_heading ); ?></h3>
				<?php } ?>
			</div>
			<div class="winning-code">
				<p><?php esc_html_e( 'The discount coupon code has been sent to your email id. Please check your email for more details.', 'supavapes' ); ?></p>
			</div>
		</div>
		<div class="thanks">
			<div class="thanks-bg">
			...
			<div class="supa-quiz-result-detail">
				...
				<?php if ( ! empty( $fq_thank_you_sub_heading ) ) { ?>
					<h3><?php echo esc_html( $fq_thank_you_sub_heading ); ?></h3>
				<?php } ?>
			</div>
