...
/**
 * Class Twilio_Order_Out_For_Delivery_SMS
 */
class Twilio_Order_Out_For_Delivery_SMS extends Twilio_SMS {
	 ...
	 * @var string
	 */
	private $template_name = 'out_for_delivery';

	/**
	 * Twilio_Order_Out_For_Delivery_SMS constructor.
	 */
	public function __construct() {
		$this->init();

		// Triggers for this email.
		add_action( 'woocommerce_order_status_shipment-ready_to_out-for-delivery', array( $this, 'trigger' ), 10, 2 );
	}
...
new Twilio_Order_Out_For_Delivery_SMS();
