...
/**
 * Class Twilio_Order_Delivered_SMS
 */
class Twilio_Order_Delivered_SMS extends Twilio_SMS {
	 ...
	 * @var string
	 */
	private $template_name = 'order_delivered';

	/**
	 * Twilio_Order_Delivered_SMS constructor.
	 */
...
new Twilio_Order_Delivered_SMS();
