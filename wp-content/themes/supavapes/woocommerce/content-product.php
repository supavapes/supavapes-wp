...
if ( $product->is_type( 'variable' ) ) {
		...
		$vaping_liquid = (int) get_post_meta( $product->get_id(), '_vaping_liquid', true );
	...
	<div class="sv-our-product-box">
		...
		<div class="sv-our-product-detail">
            ...
            <?php if ( $product_type == 'simple' ){ ?>
			    <?php echo wp_kses_post( $final_price ); ?>
            <?php } else {
		...
		<?php 
			if ( $product_data && method_exists( $product_data, 'get_type' ) ) {
				...
				<a href="<?php echo esc_url( get_permalink( $product->get_id() ));?>" class="sv-shop-btn"><?php esc_html_e( 'Select Options', 'supavapes'); ?></a> 
			<?php } else { ?>
				<a href="<?php echo esc_url( get_permalink( $product->get_id() ));?>" class="sv-shop-btn"><?php esc_html_e( 'Shop Now', 'supavapes'); ?></a> 
				<?php } ?>
			<?php } ?>
