...
$opening_paragraph = sprintf( __( 'This is to update you that your request for cancelling reservation for %1$s in order #%2$s that you placed on %3$s has been approved. The details about the reservation item are as follows:', 'hello-elementor-child' ), $item_data->first_name, $item_data->last_name,'test');
