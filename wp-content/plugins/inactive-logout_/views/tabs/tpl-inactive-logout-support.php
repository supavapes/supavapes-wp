...
<div class="ina-settings-admin-wrap ina-settings-admin-support">
	<?php if ( ! Helpers::is_pro_version_active() ) { ?>
        <div class="ina-settings-admin-support-bg">
            ...
            <p>Among many other features/enhancements, inactive logout pro comes with a additional features if you feel like you need it. <span class="dashicons dashicons-external"></span> <a target="_blank" href="https://www.inactive-logout.com/">Check out the pro version here</a></p>
            <ol>
                <li><a href="https://www.inactive-logout.com/blog/automatically-end-sessions-users-on-browser-tab-close-with-inactive-logout" target="_blank">Auto browser close logout.</a></li>
                <li>Multiple tab sync.</li>
                <li><a href="https://www.inactive-logout.com/blog/how-to-track-user-login-logout-history-using-inactive-logout-pro" target="_blank">Track Visitors</a> based on <strong>(Login time, logout time, browser, online status, session duration, role, os, IP)</strong></li>
                ...
                <li><a href="https://www.inactive-logout.com/blog/how-to-force-logout-any-users-in-wordpress" target="_blank">Force logout by admin on any users.</a></li>
                <li>Disable inactive logout for specified pages according to your need.</li>
                <li><a href="https://www.inactive-logout.com/blog/how-to-track-user-login-logout-history-using-inactive-logout-pro" target="_blank">Track User Session and Logout individually.</a></li>
                <li><a href="https://www.inactive-logout.com/blog/how-to-force-logout-any-users-in-wordpress" target="_blank">Logout popups for manually revoked user sessions.</a></li>
                <li>Logout modal popup customizations.</li>
                <li>Disable native wordpress login popup after logout.</li>
                <li>Compatibility with OpenID Connect Generic Client WordPress plugin (Kinde supported).</li>
            </ol>
            and more..
        </div>
