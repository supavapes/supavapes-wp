...
class CWSWPAdmin {
	...
	public function activateWarning() {
		global $hook_suffix;
		if (!CWSAccount::isConfigured($this->settings) && $hook_suffix == 'index.php' ) {
?>
			<div id="message" class="updated" style="padding: 8px; font-size: 16px; background-color: #dff0d8">
						<a class="button-primary" href="<?php echo esc_url($this->mainUrl()); ?>">Activate Cloudways</a>
						&nbsp;&nbsp;&nbsp;<b>Almost Done:</b> Activate your Cloudways account to migrate your site.
			</div>
<?php
		}
	}
