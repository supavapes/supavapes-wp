<?php
/**
 * Class WC_Email_Pickup_Ready_Order file.
 *
...
if ( ! class_exists( 'WC_Email_Pickup_Ready_Order', false ) ) :

	/**
	 * Self Pickup Order Email.
	 *
	 * An email sent to the customer when a order is self pickup for.
	 *
	 * @class       WC_Email_Pickup_Ready_Order
	 * @version     3.5.0
	 * @package     WooCommerce\Classes\Emails
	 * @extends     WC_Email
	 */
	class WC_Email_Pickup_Ready_Order extends WC_Email {
		...
		public function __construct() {
			...
			add_action( 'woocommerce_order_status_processing_to_pickup-ready_notification', array( $this, 'trigger' ), 10, 2 );
...
return new WC_Email_Pickup_Ready_Order();
