<?php
/**
 *  This file is used to show our juices products in slider.
 */
		...
		if ( $terms ) {
								...
								<div class="sv-our-product-box">
									...
									if ( $product_data && method_exists( $product_data, 'get_type' ) ) {
										...
										if ( $product_type === 'variable' ) {
											?>
										<a href="<?php echo esc_url( get_the_permalink() ); ?>" class="sv-shop-btn"><?php esc_html_e( 'Select Options', 'supavapes' ); ?></a>
									<?php } else { ?>
										<a href="<?php echo esc_url( get_the_permalink() ); ?>" class="sv-shop-btn"><?php esc_html_e( 'Shop Now', 'supavapes' ); ?></a>
									<?php } ?>
									<?php } ?>
			...
			<div class="center-view-btn">
				<a href="<?php echo esc_url( $sv_term_link ); ?>" class="btn view-all-btn">
					...
					<span><?php esc_html_e( 'View All', 'supavapes' ); ?></span>
				</a>
			</div>
			</div>
		</div>
