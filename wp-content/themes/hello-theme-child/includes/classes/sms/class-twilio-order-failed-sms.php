...
/**
 * Class Twilio_Order_Failed_SMS
 */
class Twilio_Order_Failed_SMS extends Twilio_SMS {
	 ...
	 * @var string
	 */
	private $template_name = 'order_failed';
	...
	public function __construct() {
		...
		add_action( 'woocommerce_order_status_pending_to_failed', array( $this, 'trigger' ), 10, 2 );
		add_action( 'woocommerce_order_status_on-hold_to_failed', array( $this, 'trigger' ), 10, 2 );
	}
