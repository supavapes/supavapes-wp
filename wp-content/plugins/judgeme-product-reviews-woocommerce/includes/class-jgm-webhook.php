...
class JGM_Webhook {
	...
	public function register_wp_api_endpoints() {
		...
		// Popup Widget Webhook
		register_rest_route( $namespace, '/widget/popup_widget/updated', array(
			'methods'  => 'POST',
			'callback' => array( $this, 'webhook_widget_popup_widget_callback' ),
			'permission_callback' => '__return_true', // authentication is handled in `handle_callback()`
		) );
	...
	public function webhook_widget_popup_widget_callback( $data ) {
		$this->handle_callback( $data, 'popup_widget' );
	}
